...
function codevz_widget_display_callback( $data, $widget_class, $args ) {
	...
	if ( ! empty( $widget_class->id ) ) {
		...
		if ( ! empty( $data['czsk_button'] ) ) {
			$css .= '#' . $id . ' button{' . Codevz_Plus::sk_inline_style( $data['czsk_button'] ) . '}';
		}
		if ( ! empty( $data['czsk_button_hover'] ) ) {
			$css .= '#' . $id . ' button:hover{' . Codevz_Plus::sk_inline_style( $data['czsk_button_hover'] ) . '}';
		}
	...
	public function fields() {
		return [
			...
			[
				'name'        => 'input_attr',
				'type'        => 'select',
				'title'       => esc_html__( 'Input type attribute', 'codevz' ),
				'options'	  => [
					'email'		=> 'email',
					'text'		=> 'text',
					'number'	=> 'number',
			...
			[
				'name' 		=> 'name_attr',
				'type' 		=> 'text',
				'title' 	=> esc_html__( 'Input name attribute', 'codevz' ),
				'default' 	=> 'email',
		...
		return [
			...
			[
				...
				'options'	  => [
					...
					'instagram' 	=> esc_html__('Instagram', 'codevz'),
				],
				'default' 	  => 'gallery',
			...
			[
				...
				'type'            => 'group',
				'title' 		  => '',
				'button_title'    => esc_html__( 'Add image(s)', 'codevz' ),
				'fields'          => [
					[
						'id'          => 'title',
						'type'        => 'text',
	...
	public function fields() {
		$fields = [
			...
			[
				'name'        => 'color_mode',
				'type'        => 'select',
				'title'       => esc_html__('Icons Color', 'codevz'),
				'options'	  => [
					'' 								=> esc_html__('Select', 'codevz'),
					'cz_social_colored' 			=> esc_html__('Original colors', 'codevz'),
					'cz_social_colored_hover' 		=> esc_html__('Original colors on hover', 'codevz'),
