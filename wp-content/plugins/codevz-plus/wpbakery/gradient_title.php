...
class Codevz_WPBakery_gradient_title {
	...
	public function in() {
		...
		vc_map( array(
			...
			'base'			=> $this->name,
			'name'			=> esc_html__( 'Gradient Title', 'codevz' ),
			'description'	=> esc_html__( 'Text with background', 'codevz' ),
			'icon'			=> 'czi',
			'params'		=> array(
				array(
					'type' 			=> 'cz_sc_id',
				...
				array(
					...
					"value"  		=> "<h1 style='font-size:50px;font-weight:700'><strong>GRADIENT TITLE</strong></h1>",
					"param_name"  	=> "content",
					'admin_label' 	=> true
				),
				array(
	...
	public function out( $atts, $content = '' ) {
		...
		return Codevz_Plus::_out( $atts, $out, 'responsive_text' );
	}
